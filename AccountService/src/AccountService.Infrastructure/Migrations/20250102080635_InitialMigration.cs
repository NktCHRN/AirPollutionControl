    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Patronymic = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                Birthday = table.Column<DateOnly>(type: "date", nullable: false),
                RestrictionNote = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                RestrictionEnd = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                PositionName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    name: "FK_AspNetUsers_Agglomerations_AgglomerationId",
        ...
        migrationBuilder.CreateIndex(
            name: "IX_AspNetUsers_AgglomerationId",
            table: "AspNetUsers",
